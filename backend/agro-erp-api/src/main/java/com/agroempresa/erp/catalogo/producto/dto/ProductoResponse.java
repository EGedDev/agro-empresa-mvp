...
public record ProductoResponse(
    ...
    public static ProductoResponse desdeEntidad(Producto producto) {
        ...
        return new ProductoResponse(
                ...
                producto.getDescripcionWeb(),
                producto.getInformacionAdicional(),
                producto.getIngredienteActivo(),
                producto.getComposicion(),
                producto.getFormulacion(),
                producto.getNumeroRegistro(),
                producto.getPresentaciones(),
                producto.getCultivos(),
                producto.getModoUso(),
                producto.getFichaTecnicaUrl(),
